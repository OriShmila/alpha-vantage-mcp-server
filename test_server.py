...
async def run_tool_test(
    ...
    try:
        ...
        from alpha_vantage_mcp_server.server import TOOL_FUNCTIONS
        ...
        if test_case.get("should_succeed", True):
            ...
            with open("alpha_vantage_mcp_server/tools.json", "r") as f:
...
async def test_server_components():
    ...
    try:
        ...
        from alpha_vantage_mcp_server.server import load_tool_schemas, TOOL_FUNCTIONS
